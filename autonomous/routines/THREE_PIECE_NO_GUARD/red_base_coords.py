...
base_path_1: path = (
    base_initial_coords,
    [],
    (6.75, config.field_width - (config.scoring_width - 1), 0),
)

base_path_2: path = (
    base_path_1[2],
    [(3.92, config.field_width - (config.scoring_width - 0.82))],
    (1.6, config.field_width - (config.scoring_width - 1.12), 0),
)

base_path_3: path = (
    base_path_2[2],
    [
        (3.35, config.field_width - (config.scoring_width - 0.85)),
...
base_path_4: path = (
    base_path_3[2],
    [
        (5.6, config.field_width - (config.scoring_width - 0.85)),
        (4.8, config.field_width - (config.scoring_width - 0.8)),
        (3.92, config.field_width - (config.scoring_width - 0.85)),
    ],
