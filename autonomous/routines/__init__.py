...
from autonomous.routines.GYRO_BALANCE.gyro_balance import routine as new_balance
from autonomous.routines.THREE_PIECE.GUARD.blue import (
    routine as blue_three_piece_with_guard,
)
from autonomous.routines.THREE_PIECE.GUARD.red import (
    routine as red_three_piece_with_guard,
)
from autonomous.routines.THREE_PIECE.NO_GUARD.blue import (
    routine as blue_three_piece_no_guard,
)
from autonomous.routines.THREE_PIECE.NO_GUARD.red import (
