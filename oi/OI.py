...
class OI:
    ...
    def map_controls():
        ...
        Keymap.Scoring.DEL.whenPressed(
            InstantCommand(lambda: confirm_current_scoring_position(False))
        )
        Keymap.Scoring.CONFIRM.whenPressed(
            InstantCommand(lambda: confirm_current_scoring_position(True))
        )
