...
class Claw(Subsystem):
    ...
    def __init__(self):
        ...
        """
        self.claw_close_piston: DoubleSolenoidPiston = DoubleSolenoidPiston(
            1, wpilib.PneumaticsModuleType.REVPH, 4
        )
    ...
    def set_angle(self, pos: float):
        ...
        self.claw_motor.set_target_position(
            (pos / (math.pi * 2))
            * constants.claw_gear_ratio  # 80 rotations per 360 degrees
        )
