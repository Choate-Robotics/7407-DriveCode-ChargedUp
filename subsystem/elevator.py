...
class Elevator(Subsystem):  # elevator class
    ...
    turn_sensor = rev.CANSparkMax(config.elevator_left_rotation_motor_id, rev.MotorType.kBrushless).getAbsoluteEncoder(
        rev._rev.SparkMaxAbsoluteEncoder.Type.kDutyCycle)  # senses the rotation of the elevator
