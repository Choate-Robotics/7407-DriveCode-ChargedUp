...
class TargetData:
    ...
    arm_length: meters
    wrist_angle: radians
    target_pose_initial: Pose2d | None
    target_pose_final: Pose2d | None = None
...
scoring_locations = {
    "low": TargetData(
        target_pose_initial=Pose2d(0, 0, 0),
    ...
    "middle": TargetData(
        target_pose_initial=Pose2d(1.99, 1.55, 0),  # 2.43 .94
        target_pose_final=Pose2d(1.51, 1.55, 0),
    ...
    "double_station": TargetData(
        target_pose_initial=Pose2d(1, 1, 0),
        arm_angle=math.radians(-44.78),
        arm_length=0.55,
        wrist_angle=math.radians(-27.09),
        intake_enabled=False,
